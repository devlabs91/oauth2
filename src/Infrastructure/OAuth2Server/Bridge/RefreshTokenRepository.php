<?php
namespace Devlabs91\Oauth2\Infrastructure\oAuth2Server\Bridge;

use League\OAuth2\Server\Entities\RefreshTokenEntityInterface;
use League\OAuth2\Server\Repositories\RefreshTokenRepositoryInterface;
use Devlabs91\Oauth2\Domain\Repository\RefreshTokenRepositoryInterface as AppRefreshTokenRepositoryInterface;
use Devlabs91\Oauth2\Domain\Model\RefreshToken as AppRefreshToken;
